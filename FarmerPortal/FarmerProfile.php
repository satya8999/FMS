            ...
            <table align="center">
                ...
                <tr align="center">
                    ...
                    <td>
                        ...
                        <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="9848449123">
                    <br></td>
                </tr>
                <tr align="center">
                    <td><label><b>Phone Number :</b></label></td>
                    <td><textarea rows="2" cols="10" disabled> <?php echo $phone ?> </textarea><br></td>
                </tr>
                <tr align="center">
